...
static const float rootcolor[]             = COLOR(0xa7c080ff);
static const float bordercolor[]           = COLOR(0xa7c080ff);
...
static const char *const autostart[] = {
        "swaybg","-i", "/home/aboud/.config/digital-digital-art-artwork-illustration-drawing-hd-wallpaper-b8d68d48c0e06c1810ac414e7892f49a.jpg", NULL,
        "dunst",NULL,
        "brave",NULL,
        "foot","--server",NULL,
        NULL /* terminate */
...
static const Rule rules[] = {
	...
	{ "brave", NULL,            8 << 1,       0,         default_opacity,         1,      1,         -1,      0 },
};
...
static const char *broswer[] = { "brave", NULL };
/* NOTE: named scratchpads - First arg only serves to match against key in rules*/
...
static const Key keys[] = {
	...
	{ MODKEY,					XKB_KEY_p,			 spawn,           {.v = (const char*[]){ TERMINAL,"-e","/home/aboud/.local/bin/scripts/programming/new.sh", NULL } } },
